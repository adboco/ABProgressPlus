...
static DGActivityIndicatorAnimationType DGActivityIndicatorDefaultAnimationType;
...
@property (nonatomic, readwrite) DGActivityIndicatorAnimationType animationType;
...
@property (nonatomic, strong) DGActivityIndicatorView *indefiniteAnimatedView;
...
- (void)showProgress:(float)progress status:(NSString*)string animType:(DGActivityIndicatorAnimationType)animType maskType:(SVProgressHUDMaskType)hudMaskType;
...
+ (void)setDefaultAnimationType:(DGActivityIndicatorAnimationType)animationType{
    [self sharedView];
    DGActivityIndicatorDefaultAnimationType = animationType;
}
...
+ (void)showWithAnimationType:(DGActivityIndicatorAnimationType)animType {
    [self showWithAnimationType:animType maskType:SVProgressHUDDefaultMaskType];
}
...
+ (void)showWithAnimationType:(DGActivityIndicatorAnimationType)animType maskType:(SVProgressHUDMaskType)maskType {
    [self showWithStatus:nil animType:animType maskType:maskType];
}
...
+ (void)showWithStatus:(NSString *)status animType:(DGActivityIndicatorAnimationType)animType {
    [self showWithStatus:status animType:animType maskType:SVProgressHUDDefaultMaskType];
}
...
+ (void)showWithStatus:(NSString *)status animType:(DGActivityIndicatorAnimationType)animType maskType:(SVProgressHUDMaskType)maskType {
    [self showProgress:SVProgressHUDUndefinedProgress status:status animType:animType maskType:maskType];
}
...
+ (void)showProgress:(float)progress status:(NSString *)status animType:(DGActivityIndicatorAnimationType)animType maskType:(SVProgressHUDMaskType)maskType {
    [[self sharedView] showProgress:progress status:status animType:animType maskType:maskType];
}
...
- (instancetype)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        DGActivityIndicatorDefaultAnimationType = DGActivityIndicatorAnimationTypeDefault;
    }
...
- (void)showProgress:(float)progress status:(NSString*)string maskType:(SVProgressHUDMaskType)hudMaskType {
    [self showProgress:progress status:string animType:DGActivityIndicatorDefaultAnimationType maskType:hudMaskType];
}
...
- (void)showProgress:(float)progress status:(NSString*)string animType:(DGActivityIndicatorAnimationType)animType maskType:(SVProgressHUDMaskType)hudMaskType {
    ...
    [self.indefiniteAnimatedView setType:self.animationType];
...
- (DGActivityIndicatorView *)indefiniteAnimatedView {
    if (_indefiniteAnimatedView == nil) {
        _indefiniteAnimatedView = [[DGActivityIndicatorView alloc] initWithType:DGActivityIndicatorAnimationTypeTripleRings tintColor:SVProgressHUDForegroundColor];
        [_indefiniteAnimatedView startAnimating];
